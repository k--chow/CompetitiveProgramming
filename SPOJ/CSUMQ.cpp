...
class SegmentTree {
    ...
    void build(int start_index, int end_index, int tree_index)
    {
       ...
       if (range[index].first >= query_left && range[index].second <= query_right) {
              ...
              //this means Ônode_idxÕ does not contain anything
              ...
              //in this case, we canÕt really figure out what to return,
